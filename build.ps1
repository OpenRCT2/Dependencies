...
msbuild ".\src\sdl_ttf\VisualC\SDL_ttf.vcxproj" "/p:Configuration=Release" "/p:Platform=Win32" "/p:PlatformToolset=v140" "/v:minimal"
Write-Host
...
pushd .\src\boost
    .\bootstrap.bat
    .\b2 --layout=system --with-filesystem toolset=msvc address-model=32 variant=release link=static  runtime-link=static threading=multi
popd
